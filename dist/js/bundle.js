...
function form() {
  ...
  form.addEventListener('submit', function (event) {
    ...
    request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded'); //request.setRequestHeader ('Content-Type' , 'application/json; charset=utf-8'); //IF IN PROJECT USED JSON

    var formData = new FormData(form); //let obj = {};
...
function timer() {
  ...
  function getTimeRemaining(endtime) {
    var t = Date.parse(endtime) - Date.parse(new Date()),
        ...
        hours = Math.floor(t / (1000 * 60 * 60)); //  hours = Math.floor((t/1000/60/60) % 24); //Another wariant of calculate hours//
  ...
  function setClock(id, endtime) {
    //id is block, which have a timer//
